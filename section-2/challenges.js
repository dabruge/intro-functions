...
const isInThe20thCentury = (year) => year >= 1901 && year <= 2000
// isInThe20thCentury()
...
// getCharCode()
const getCharCode = (char) => `The ASCII code for ${char} is ${char.charCodeAt(0)}`
...
const collectStrings = (arr) => arr.filter(element => typeof element === 'string')
// collectStrings()
