...
function readTrafficLight(colour) {
  ...
  const colourToLower = colour.toLowerCase()
  ...
  return responses[colourToLower]
}
...
//Exercise 6
function updateCoinMachine(coinmachine, cointype) {
  /*
...
//Exercise 7
function updatePosition(coordinate, direction) {
  /*
  ...
  */
  ...
  switch (direction) {
    case 'up': coordinate[1]++; break;
    case 'down': coordinate[1]--; break;
    case 'left': coordinate[0]--; break;
    case 'right': coordinate[0]++; break;
  }
...
// Exercise 9
function checkGame(number, toss) {
...
function addCoins(coinCollection, coin) {
  ...
  */
  ...
  if (coin in coinTypeToIndex) {
    coinCollection[coinTypeToIndex[coin]].push(coin)
  }
